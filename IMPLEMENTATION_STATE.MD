...
- **rule_engine.py** ❌: Fast pre-LLM validation rules
- **llm_analyzer.py** ❌: LLM-powered consistency checking
- **prompt_templates.py** ❌: Optimized prompts for each check type
- **suggestion_generator.py** ❌: AI-powered fix suggestions
